...
fn prediction_test_0_0() {
    ...
    let expected_log = Log::builder()
        .dest(ACCOUNTS[1])
        .payload(LogicGateEvent::Prediction(vec![String::from("0.009806929001")]));
    res = xgnn.send(ACCOUNTS[1], LogicGateAction::Predict((
        BinaryLogic::Zero, 
        BinaryLogic::Zero 
    )));
...
fn prediction_test_0_1() {
    ...
    let expected_log = Log::builder()
        .dest(ACCOUNTS[1])
        .payload(LogicGateEvent::Prediction(vec![String::from("0.9954791929")]));
    res = xgnn.send(ACCOUNTS[1],  LogicGateAction::Predict((
        BinaryLogic::Zero, 
        BinaryLogic::One, 
    )));
...
fn prediction_test_1_0() {
    ...
    let expected_log = Log::builder()
        .dest(ACCOUNTS[1])
        .payload(LogicGateEvent::Prediction(vec![String::from("0.9954788196")]));
    res = xgnn.send(ACCOUNTS[1],  LogicGateAction::Predict((
        BinaryLogic::One, 
        BinaryLogic::Zero, 
    )));
...
fn prediction_test_1_1() {
    ...
    let expected_log = Log::builder()
        .dest(ACCOUNTS[1])
        .payload(LogicGateEvent::Prediction(vec![String::from("0.046008109555")]));
    res = xgnn.send(ACCOUNTS[1],  LogicGateAction::Predict((
        BinaryLogic::One, 
        BinaryLogic::One, 
    )));
